    ...
    try {
      ...
      const combat = CombatModule.create({
        ...
        rules: {
          ...
          blockSoftC: extras.combatRules?.blockSoftC ?? policy.combat.blockSoftC,
          blockChanceCap: extras.combatRules?.blockChanceCap ?? policy.combat.blockChanceCap,
          ragChokesDef: extras.combatRules?.ragChokesDef ?? policy.combat.ragChokesDef,
