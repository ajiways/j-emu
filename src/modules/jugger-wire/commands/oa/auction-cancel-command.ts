...
import { auctionCancelMutation } from "../../application/auction-lot-mutation.ts";
import { buildLotListBlock, loadAuctionOwners } from "../../application/lot-list-block.ts";
import { ProtocolError } from "../../application/protocol-error.ts";
import type { OaCommand, OaEncodedResponse } from "./oa-command.ts";
import type { ObjectActionEnvelope } from "./object-action-envelope.ts";

export class AuctionCancelCommand implements OaCommand {
  static readonly key = "auction|cancel";
  readonly key = AuctionCancelCommand.key;

  constructor(
    private readonly bootstrap: BootstrapReadModel,
    private readonly characters: CharacterService,
    private readonly cancel: AuctionCancel,
