...
const lineJustifications: Readonly<Record<string, string>> = {
  ...
  "src/app/quest-desk.ts":
    "Quest OA router: NPC board/dialog, book list/cancel/delete, AREA waiting, OPEN_STORE ComeIn leftover, script effects, and CMB-09 quest fight start",
  ...
  "src/modules/quests/infrastructure/postgres-quest-decode.ts":
    "Hydrates authored quest rows including board links, awardRep, onAccept, JUMP_AREA, OPEN_STORE, and ambush START_FIGHT",
  "src/modules/content/application/collect-quest-issues.ts":
    "Playable quest completeness: eight engine quests, NPC 271/272 hotspots, talk objectId, awardRep tracks, unique point ids, and OPEN_STORE store areas",
  ...
  "src/modules/content/infrastructure/merge-generated-bundle-files.ts":
    "Concatenates items/bots/loot/spells/areas/links/hunt/store/reputation/bonus/use/assistant/farm/recipe/dungeon generated JSON into the playable bundle before parse",
  ...
  "src/modules/combat/application/combat-melee-loop.ts":
    "Hunt melee scheduler: player strike, bot counter, turn grant, CMB-08 waiter handoff, aggro reserve-swap, and delay tokens",
  ...
  "src/modules/content/application/content-validator.ts":
    "Single bundle completeness gate including store 504/552 pay and RANK, reputation, professions 2/6, assistant 3/13, farm 4 on area 500, craft recipe 61, set bonuses, USE representatives, fight extra blobs, bot loot, bot spell books, dungeon definitions, battlegrounds, NPC 271/272, and eight engine quests",
