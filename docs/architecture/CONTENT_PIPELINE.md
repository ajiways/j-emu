...
Текущая `playable-slice/v21` release — минимальный bundle: 31 artifacts
...
USE **640/623/2371/55/584**; без 209 и патронташа), 5 bots (2/4/24/32/99) с overlay reward scalars; loot entries только у bot 2 (77/93/99),
bonus **601**, use script **2827**,
6 areas (503/501/504/495/552/542), authored travel `area_links` including 501↔542, hunt 50310 (home), 50309 (route+respawn) и 50101–50103 (zone), dungeon artikul `1` (ogre cave, bot 99), store 504 type `-131` lots 80/23 и 82/24, store 552 type 11 lot 438/621 RANK, reputation track **5**, 15 skills (включая **MAGSTR**), 14 levels с normalized managed skills,
...
рыжий 394); огр 99 — пустая книга. Это нельзя называть полным игровым контентом или полным контентом
цикла 1–8.
