...
Текущая `playable-slice/v16` release — минимальный bundle: 17 artifacts
(9095 + dump-proven L1 greyset **20/21/26**, glove spells **9098/9100/9099**, pocketables **93** и **99**, food **77**,
shop wear **23** и **24**, upgrade crystals **553/1310/4603/11408/13224**; без 209 и патронташа), 1 bot с overlay reward scalars и `bot_loot_entries` 77/93/99,
3 areas (503/501/504), authored travel `area_links`, 1 hunt spawn на 503, store 504 type `-131` и lots 80/23 и 82/24, reputation track **5**, 14 skills, 8 levels с normalized managed skills,
