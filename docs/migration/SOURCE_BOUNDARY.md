...
Текущая БД `j-emu` содержит минимальный `playable-slice/v18` (artifacts 9095,
20, 21, 26, 9098, 9100, 9099, 93, 99, 77, 23, 24, 553, 1310, 4603, 11408, 13224, recruit 27/28/30/33/35/106, mix 43/46, USE 640/623/2371/55/584; bots 2/4/24/32 и `spellBook` (пустая у 2; 396/422/394 у 4/32/24), hunts 50310/50101–50103; overlay loot only bot 2: 77/93/99; areas 503/501/504 и travel `area_links`; store 504 type `-131` lots 23/24; reputation track 5; bonus 601; use script 2827). DATA-02 импорт корпуса ещё не сделан.
