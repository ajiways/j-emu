...
Текущая БД `j-emu` содержит минимальный `playable-slice/v13` (artifacts 9095,
9098, 9100, 9099, 93, 99, 77, 23, 24; bot 2 overlay loot 77/93/99; areas 503/501/504 и travel `area_links`; store 504 type `-131` lots 23/24). DATA-02 импорт корпуса ещё не сделан.
