...
Текущая БД `j-emu` содержит минимальный `playable-slice/v12` (artifacts 9095,
9098, 9100, 9099, 93, 99, 77; bot 2 overlay loot 77/93/99; areas 503/501/504 и travel `area_links`). DATA-02 импорт корпуса ещё не сделан.
