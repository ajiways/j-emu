...
Текущая БД содержит только **минимальный playable slice v7**, а не полный
контент игры или цикла 1–8. Artifacts: **9095**, **93**, **99**. Медальон 209 и
патронташ не входят:

- 3 artifacts: `9095`, `93`, `99`;
- 1 bot: `2`;
- 1 area: `503`;
- 1 hunt spawn: `50310`;
...
| Статус        | Значение                                                                                                                  |
| ------------- | ------------------------------------------------------------------------------------------------------------------------- |
| `ACTIVE-MIN`  | Тип материализуется из активной playable-slice/v7 release, но данных только для минимального bootstrap/fight/pocket smoke |
...
| ------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------ |
| DATA-01 / bootstrap bundle            | `j-emu/content/playable-slice.json`, `common-conf.json`; вручную выделенный baseline с schema `playable-slice/v7` + artifact `priceMinor`/`flags`/`bagStack` на 9095/93/99                               | `catalog` + content publication                                            | `catalog.artifacts`, `bots`, `skill_definitions`, `level_boundaries`, `level_skill_values`, `appearance_presets`, game-wide docs; `ACTIVE-MIN` | IDs перечислены в bundle; artifact skill refs должны существовать в skills; area/hunt refs — ниже                  | v7 parser/validator/materializer требуют priceMinor/flags/bagStack                                                                                           | нет                                                             | Ровно 3 artifacts (9095, 93, 99), 1 bot, 1 area, 1 spawn, 11 skills, 8 levels, 48 managed skill rows, 1 appearance и singleton docs; checksum текущего bundle                                                                                                                                        | bootstrap, bag/equipment, CHR-01, INV-02 DROP, INV-03 pocket, minimal hunt fight | Только минимальный playable v7 slice (9095, 93, 99); 209 и патронташ не входят                   |
