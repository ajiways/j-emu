...
| ------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------- | ------------------------------------------------------------------------------------------------ |
| DATA-01 / bootstrap bundle            | `j-emu/content/playable-slice.json`, `common-conf.json`; вручную выделенный baseline с schema `playable-slice/v5`                                                                                        | `catalog` + content publication                                            | `catalog.artifacts`, `bots`, `skill_definitions`, `level_boundaries`, `level_skill_values`, `appearance_presets`, game-wide docs; `ACTIVE-MIN` | IDs перечислены в bundle; artifact skill refs должны существовать в skills; area/hunt refs — ниже                  | v5 parser/validator/materializer существуют; проверяют текущий ограниченный contract                                                                         | нет                                                             | Ровно 1 artifact, 1 bot, 1 area, 1 spawn, 11 skills, 8 levels, 48 managed skill rows, 1 appearance и singleton docs; checksum текущего bundle                                                                                                                                                        | bootstrap, bag/equipment, CHR-01, minimal hunt fight           | Только минимальный playable v5 slice; не full content                                            |
