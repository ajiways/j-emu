...
| Статус        | Значение                                                                                                           |
| ------------- | ------------------------------------------------------------------------------------------------------------------ |
| `ACTIVE-MIN`  | Тип материализуется из активной playable-slice/v6 release, но данных только для минимального bootstrap/fight smoke |
...
| ------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------- | ------------------------------------------------------------------------------------------------ |
| DATA-01 / bootstrap bundle            | `j-emu/content/playable-slice.json`, `common-conf.json`; вручную выделенный baseline с schema `playable-slice/v6` + artifact `priceMinor`/`flags`/`bagStack` на 9095                                     | `catalog` + content publication                                            | `catalog.artifacts`, `bots`, `skill_definitions`, `level_boundaries`, `level_skill_values`, `appearance_presets`, game-wide docs; `ACTIVE-MIN` | IDs перечислены в bundle; artifact skill refs должны существовать в skills; area/hunt refs — ниже                  | v6 parser/validator/materializer требуют priceMinor/flags/bagStack                                                                                           | нет                                                             | Ровно 1 artifact, 1 bot, 1 area, 1 spawn, 11 skills, 8 levels, 48 managed skill rows, 1 appearance и singleton docs; checksum текущего bundle                                                                                                                                                        | bootstrap, bag/equipment, CHR-01, INV-02 DROP, minimal hunt fight | Только минимальный playable v6 slice; второго artifact нет без dump provenance                   |
