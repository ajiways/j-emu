...
instance flags/price; unique wearable. Bundle сейчас `playable-slice/v21`.
...
`playable-slice/v21`. Pocket occupancy — partial unique в `0000_foundation_init`.
...
`playable-slice/v21`. Все артефакты обязаны иметь оба поля.
...
`playable-slice/v21`. Dump `Pub1/images/locale/ru/amf/artifact_artikul_*.amf`.
