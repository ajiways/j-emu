...
instance flags/price; unique wearable. Bundle сейчас `playable-slice/v22`.
...
`playable-slice/v22`. Pocket occupancy — partial unique в `0000_foundation_init`.
...
`playable-slice/v22`. Все артефакты обязаны иметь оба поля.
...
`playable-slice/v22`. Dump `Pub1/images/locale/ru/amf/artifact_artikul_*.amf`.
