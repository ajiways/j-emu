...
esrv `user|bag_diff` после `store|repair` снимает слот и возвращает
...
CEF 2026-09-17, орб 99 standing+effPurge CEF 2026-09-17, glove AOE raw-AMF
...
quest roster flags 8, дебаффы, bot AOE, dealtDamage,
